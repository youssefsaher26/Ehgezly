...
namespace Ehgezly
{
    public partial class Trainer_Homepage : Form
    {
        ...
        private void cancelupcomingsessions_Click(object sender, EventArgs e)
        {
            Cancel_Sessions R = new Cancel_Sessions(password, email);
            R.Show();
        }

        private void checkupcaomingtournaments_Click(object sender, EventArgs e)
        {
            Tournaments_Trainer_Upcoming R = new Tournaments_Trainer_Upcoming(password, email);
            R.Show();
        }

        private void cancelupcomingtournaments_Click(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int r = controllerObj.AddAvailableTrainingSessionTimeslots(dateTimePicker1.Value.ToString("yyyy-MM-dd HH:mm"), dateTimePicker2.Value.ToString("yyyy-MM-dd HH:mm"),controllerObj.GetID(email));
